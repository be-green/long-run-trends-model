function [loss, emp_mom, theor_mom, diff_coefs, reg_coefs, p10_diff_coefs, p10_reg_coefs] = lrtmodel_no_displacement(paramvec, make_plots, hyperparams)
...
[theor_mom, diff_coefs, reg_coefs, p10_diff_coefs, p10_reg_coefs] = calcmom_no_displacement(lambda, mu, theta_grid, steady_state, xi_star, ...
    kappa, rho, sigma_param, alpha_param, phi, xi_var, ...
    A_0, A_1, ...
    c_0_tilde, c_1_tilde, omega, n_periods, v, ...
