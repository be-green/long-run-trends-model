...
options = optimoptions('particleswarm',...
    ...
    true,'SwarmSize', 1000);
[sol, loss] = particleswarm(@(x) lrtmodel(x, H_inside, 0, 80), 10, ...
    [0.005, 0.005, 0.005, 0.25, -1,   0.5, 0.001, -10, 0.001, 0.001], ...
    [0.1,   0.99,  0.1,    5, 0.75,    0.9, 0.25, 10, 0.99, 0.99], options);
