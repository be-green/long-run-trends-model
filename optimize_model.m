...
[sol, loss] = particleswarm(@(x) lrtmodel(x, H_inside), 8, ...
    [0.005, 0.005, 0.005, 0.25, -1,   0.5, 0.005, -10], ...
    [0.1,   0.99,  0.1,    5, 0.75,    0.9, 0.25, 10], options);
...
fmincon(@(x) lrtmodel(x, H_inside), ...
    [0.0864    0.0019    0.0010    0.2386    0.3317    0.6554    0.0044, 0.5], ...
    [0.005, 0.005, 0.005, 0.25, -1,   0.5, 0.005, 0.01], ...
    [0.1,   0.99,  0.1,    5, 0.75,    0.9, 0.25, 0.99], options);
