function [ upper, lower, Aineq, bineq] = build_constraints_v2(n_periods,n_gridpoints)
...
% set lower bound on expected human capital growth
dlogtheta_ub = 0.9 * delta; % expected level of HC at end of career is 0.6;
...
bineq = -dlogtheta_lb;
Aineq = [-growth_rate, 0, 1, 0, 0, 0, 0, 0, 0, 0];
